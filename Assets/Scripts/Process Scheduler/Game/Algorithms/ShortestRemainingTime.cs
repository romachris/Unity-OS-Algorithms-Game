...
public class ShortestRemainingTime : LevelController
{
    protected string[] srtWrong = new string[7];
    ...
    private void Start()
    {
        Debug.Log("SRT start");
        this.levelNumber = 1;
        this.algorithmName = "Shortest Remaining Time";
    ...
    public override void processClick()
    {
        ...
        if (index != -1)
        {
            ...
            for (int i = 0; i < processes.Count; i++)
            {
                ...
                {
                    feedbackText.text = srtWrong[Random.Range(0, 3)];
                ...
                {
                    feedbackText.text = srtWrong[Random.Range(6, srtWrong.Length - 1)];
                    feedbackText.gameObject.SetActive(true);
                    //Wrong answer
                    bonusCounter = 1;
                    //reduce from score 
    ...
    {
        srtWrong[0] = "Check the size again";
        srtWrong[1] = "There is a shortest process";
        srtWrong[2] = "Check again";
        srtWrong[3] = "Check the width of the processes";
        srtWrong[4] = "Correct size but wrong order";
        srtWrong[5] = "Correct size but pick the one that arrived first";
        srtWrong[6] = "First size then order";
    }
}
